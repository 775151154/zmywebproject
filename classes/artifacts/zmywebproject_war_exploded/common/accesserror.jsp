...
<div style="width:1024px;height:350px;text-align:center;margin:100px auto 0;background:url(<%=request.getContextPath()%>/common/images/error.png)">
	<div style="float:left;margin:130px 0 0 450px;">
		...
		<p style="color:#333;font-size:24px;color:#00706b;border-top:2px solid #00706b;line-height:60px;padding:0 25px;">抱歉…… 您无权访问当前页面!</p>
	</div>
</div>

<%-- 
<div style="width:470px;height:250px;text-align:center;margin:100px auto;"><img src="images/error.png" width="462" height="214" />
<p style="font-size: 24px;color: #00706b;">无权访问当前页面!</p></div>
...
<table width="100%" height="100%" bgcolor="#FFFFFF">
	<tr height="80%">
		...
		<table border="0" width="575px" height="111px"
		    ...
		    <tr >
				<td></td>
				<td id="msg" style="font:16px;word-break:break-all">无权访问当前页面！</td>
				<td></td>
			</tr>
		</table>
